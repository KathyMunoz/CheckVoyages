    ...
    public function renderList(array $destinations, string $groupName): string {
        ...
        if (empty($destinations)) {
            ...
            foreach ($destinations as $dest) {
                $html .= "<a href='destination.php?id=".$dest['id_destination']."' class='card card-image' style='border: solid 2px rgb(255 113 12); border-radius: 10px; overflow: hidden; text-align: center; padding: 1rem; text-decoration: none; color: black;'>
                            <img src='images/".$dest['thumbnail']."' alt='".$dest['title']."' style='width: 100%; max-width:150px; height: 160px; object-fit: cover; margin-bottom: 1rem; border-radius: 8px;'>
